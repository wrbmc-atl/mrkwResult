                    ...
                    using (OracleCommand cmd = new OracleCommand(packageName, conn))
                    {
                        ...
                        using (OracleDataReader reader = await cmd.ExecuteReaderAsync())
                        {
                            while (await reader.ReadAsync())
                            {
                                ...
                                item.DISPORDER = reader.IsDBNull(reader.GetOrdinal("DISPORDER")) ? (long?)null : reader.GetInt64(reader.GetOrdinal("DISPORDER"));
                                ...
                                item.SKSI_DT = reader.IsDBNull(reader.GetOrdinal("SKSI_DT")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("SKSI_DT"));
                                item.SKSIPGR_CD = reader.IsDBNull(reader.GetOrdinal("SKSIPGR_CD")) ? string.Empty : reader.GetString(reader.GetOrdinal("SKSIPGR_CD"));
                                item.SISIKSHN_DT = reader.IsDBNull(reader.GetOrdinal("SISIKSHN_DT")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("SISIKSHN_DT"));
                    ...
                    using (OracleCommand cmd = new OracleCommand(packageName, conn))
                    {
                        ...
                        using (OracleDataReader reader = await cmd.ExecuteReaderAsync())
                        {
                            while (await reader.ReadAsync())
                            {
                                ...
                                item.RACE_DATE = reader.IsDBNull(reader.GetOrdinal("RACE_DATE")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("RACE_DATE"));
                                item.START_CD = reader.IsDBNull(reader.GetOrdinal("START_CD")) ? string.Empty : reader.GetString(reader.GetOrdinal("START_CD"));
                                item.GOAL_CD = reader.IsDBNull(reader.GetOrdinal("GOAL_CD")) ? string.Empty : reader.GetString(reader.GetOrdinal("GOAL_CD"));
                                item.STAGE_TYP = reader.IsDBNull(reader.GetOrdinal("STAGE_TYP")) ? string.Empty : reader.GetString(reader.GetOrdinal("STAGE_TYP"));
                                item.REVERSE_FLG = reader.IsDBNull(reader.GetOrdinal("REVERSE_FLG")) ? string.Empty : reader.GetString(reader.GetOrdinal("REVERSE_FLG"));
                                item.MIRROR_FLG = reader.IsDBNull(reader.GetOrdinal("MIRROR_FLG")) ? string.Empty : reader.GetString(reader.GetOrdinal("MIRROR_FLG"));
                                item.RANK = reader.IsDBNull(reader.GetOrdinal("RANK")) ? (long?)null : reader.GetInt64(reader.GetOrdinal("RANK"));
                                item.HEADCOUNT = reader.IsDBNull(reader.GetOrdinal("HEADCOUNT")) ? (long?)null : reader.GetInt64(reader.GetOrdinal("HEADCOUNT"));
                                item.RATE_END = reader.IsDBNull(reader.GetOrdinal("RATE_END")) ? (long?)null : reader.GetInt64(reader.GetOrdinal("RATE_END"));
                                item.REMARK = reader.IsDBNull(reader.GetOrdinal("REMARK")) ? string.Empty : reader.GetString(reader.GetOrdinal("REMARK"));
                                item.SKSI_DT = reader.IsDBNull(reader.GetOrdinal("SKSI_DT")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("SKSI_DT"));
                                item.SISIKSHN_DT = reader.IsDBNull(reader.GetOrdinal("SISIKSHN_DT")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("SISIKSHN_DT"));
                    ...
                    using (OracleCommand cmd = new OracleCommand(packageName, conn))
                    {
                        ...
                        using (OracleDataReader reader = await cmd.ExecuteReaderAsync())
                        {
                            while (await reader.ReadAsync())
                            {
                                ...
                                item.NUM1 = reader.IsDBNull(reader.GetOrdinal("NUM1")) ? (long?)null : reader.GetInt64(reader.GetOrdinal("NUM1"));
                                item.NUM2 = reader.IsDBNull(reader.GetOrdinal("NUM2")) ? (long?)null : reader.GetInt64(reader.GetOrdinal("NUM2"));
                                item.NUM3 = reader.IsDBNull(reader.GetOrdinal("NUM3")) ? (long?)null : reader.GetInt64(reader.GetOrdinal("NUM3"));
                                item.NUM4 = reader.IsDBNull(reader.GetOrdinal("NUM4")) ? (long?)null : reader.GetInt64(reader.GetOrdinal("NUM4"));
                                item.NUM5 = reader.IsDBNull(reader.GetOrdinal("NUM5")) ? (long?)null : reader.GetInt64(reader.GetOrdinal("NUM5"));
                                item.DEC1 = reader.IsDBNull(reader.GetOrdinal("DEC1")) ? (decimal?)null : reader.GetDecimal(reader.GetOrdinal("DEC1"));
                                item.DEC2 = reader.IsDBNull(reader.GetOrdinal("DEC2")) ? (decimal?)null : reader.GetDecimal(reader.GetOrdinal("DEC2"));
                                item.DEC3 = reader.IsDBNull(reader.GetOrdinal("DEC3")) ? (decimal?)null : reader.GetDecimal(reader.GetOrdinal("DEC3"));
                                item.DEC4 = reader.IsDBNull(reader.GetOrdinal("DEC4")) ? (decimal?)null : reader.GetDecimal(reader.GetOrdinal("DEC4"));
                                item.DEC5 = reader.IsDBNull(reader.GetOrdinal("DEC5")) ? (decimal?)null : reader.GetDecimal(reader.GetOrdinal("DEC5"));
                                item.DATETIME1 = reader.IsDBNull(reader.GetOrdinal("DATETIME1")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("DATETIME1"));
                                item.DATETIME2 = reader.IsDBNull(reader.GetOrdinal("DATETIME2")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("DATETIME2"));
                                item.DATETIME3 = reader.IsDBNull(reader.GetOrdinal("DATETIME3")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("DATETIME3"));
                                item.DATETIME4 = reader.IsDBNull(reader.GetOrdinal("DATETIME4")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("DATETIME4"));
                                item.DATETIME5 = reader.IsDBNull(reader.GetOrdinal("DATETIME5")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("DATETIME5"));
                                item.DATE1 = reader.IsDBNull(reader.GetOrdinal("DATE1")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("DATE1"));
                                item.DATE2 = reader.IsDBNull(reader.GetOrdinal("DATE2")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("DATE2"));
                                item.DATE3 = reader.IsDBNull(reader.GetOrdinal("DATE3")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("DATE3"));
                                item.DATE4 = reader.IsDBNull(reader.GetOrdinal("DATE4")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("DATE4"));
                                item.DATE5 = reader.IsDBNull(reader.GetOrdinal("DATE5")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("DATE5"));
                                item.TIME1 = reader.IsDBNull(reader.GetOrdinal("TIME1")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("TIME1"));
                                item.TIME2 = reader.IsDBNull(reader.GetOrdinal("TIME2")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("TIME2"));
                                item.TIME3 = reader.IsDBNull(reader.GetOrdinal("TIME3")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("TIME3"));
                                item.TIME4 = reader.IsDBNull(reader.GetOrdinal("TIME4")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("TIME4"));
                                item.TIME5 = reader.IsDBNull(reader.GetOrdinal("TIME5")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("TIME5"));
                                item.SKSI_DT = reader.IsDBNull(reader.GetOrdinal("SKSI_DT")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("SKSI_DT"));
                                item.SKSIPGR_CD = reader.IsDBNull(reader.GetOrdinal("SKSIPGR_CD")) ? string.Empty : reader.GetString(reader.GetOrdinal("SKSIPGR_CD"));
                                item.SISHKSHN_DT = reader.IsDBNull(reader.GetOrdinal("SISHKSHN_DT")) ? (DateTime?)null : reader.GetDateTime(reader.GetOrdinal("SISHKSHN_DT"));
